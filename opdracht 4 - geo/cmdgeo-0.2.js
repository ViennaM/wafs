...
/***
* TODO:
*   geen global variablen/objecten
*   camelCase
*   enters toevoegen
*   variablen 1 keer of niet gebruikt
*   indenting
*   puntkomma's
*   functies groeperen adhv namen (app: init + start_interval, location/position, google maps, debugging, helper)
*       location: update, set, check, getDistance
*       
*   functienamen soms wel _ soms niet
*   minified code in aparte module zetten en dan importeren
*/
